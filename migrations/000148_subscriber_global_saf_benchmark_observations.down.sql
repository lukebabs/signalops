...
DROP TRIGGER IF EXISTS trg_subscriber_global_saf_benchmark_observation_immutable ON subscriber_global_saf_benchmark_observations;
DROP FUNCTION IF EXISTS subscriber_global_saf_benchmark_observation_immutable_guard();
DROP TABLE IF EXISTS subscriber_global_saf_benchmark_observations;
