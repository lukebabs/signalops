DELETE FROM schema_migrations WHERE version='000167_subscriber_subject_identity_labels';

DROP TABLE IF EXISTS subscriber_subject_identity_labels;

-- Restore the prior identity-label resolver shape from 000166.
