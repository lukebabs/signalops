-- Subscriber global analytical-data-plane: core VC/DOSM valuation results are platform-owned valuation evidence. Watchlists authorize symbols at Gateway.

CREATE VIEW subscriber_gateway_global_valuation_results WITH (security_barrier = true) AS
