-- Historical outcome source_type is retained inside outcome_payload by the
-- original immutable parity manifest. Resolve that representation without
-- altering any source or global-evidence record.
