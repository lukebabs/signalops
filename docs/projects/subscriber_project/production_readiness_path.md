...
| Mobile subscriber UX | Initial automated smoke passed / sprint open | `scripts/run_subscriber_mobile_ui_smoke.sh` validates production login and core subscriber routes at 375px, 390px, and 430px phone widths: Dashboard, Watchlists, Assets, Sector Rotation, Syncratic Intelligence, and Dashboard-to-Syncratic handoff. The broader PR-5 drilldown, enrollment, and subscription-pricing checks remain open. |
