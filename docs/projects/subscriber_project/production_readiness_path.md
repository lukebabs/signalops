...
| Service mesh / ingress | Mesh-1 closed, route parity pending | Istio control-plane readiness passed on 2026-09-13: `istio-base` and `istiod` deployed, Istio and Gateway API CRDs present, `GatewayClass/istio` accepted, `public-ingress` programmed at `192.168.2.233`, and SignalOps namespaces have no auto-injection/dataplane enrollment. Evidence: [Mesh-1 Istio readiness evidence — 2026-09-13](k8s_mesh1_istio_readiness_2026-09-13.md). |
