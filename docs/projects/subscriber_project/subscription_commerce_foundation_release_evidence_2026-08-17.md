...
## Pilot provisioning evidence â€” 2026-08-17
...
- Explorer â€” controlled `tenant-pilot-b` subscriber.
- Professional â€” controlled `tenant-local` non-admin subscriber.
- Institutional â€” `luke@strategiclabs.io` as the active `tenant_admin` seat on the `tenant-local` Institutional contract.
