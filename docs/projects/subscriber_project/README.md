...
- [SignalOps SaaS Kubernetes Platform Architecture](saas_kubernetes_platform_architecture.md): accepted target namespace/operational-plane model for scaling SignalOps, Signal-Connect, MarketOps, CyberOps, identity, data, and observability as one SaaS platform.
...
- [K8S-2 staging app manifest evidence — 2026-09-12](k8s2_staging_app_manifest_evidence_2026-09-12.md): staging-only web/gateway manifests, OpenBao injector path, probes, pool caps, and server-side dry-run evidence without applying workloads.
- [K8S-3 MarketOps scheduled jobs scaffold — 2026-09-12](k8s3_marketops_scheduled_jobs_scaffold_2026-09-12.md): dedicated job-runner target and suspended CronJob manifests for the first MarketOps worker-conversion gate.
- [K8S-3 suspended CronJob apply evidence — 2026-09-12](k8s3_suspended_cronjob_apply_evidence_2026-09-12.md): in-cluster suspended CronJob apply/list smoke, zero Jobs/Pods proof, and GHCR publication blocker.
- [K8S-3 MarketOps image pull and OpenBao staging evidence — 2026-09-12](k8s3_marketops_image_pull_openbao_staging_evidence_2026-09-12.md): private GHCR pull smoke in `signalops-marketops`, placeholder-only OpenBao MarketOps role/path, and cross-plane denial proof.
- [K8S-3 scheduler status parity evidence — 2026-09-12](k8s3_scheduler_status_parity_evidence_2026-09-12.md): one-shot non-provider Kubernetes dry-run with DB-backed `marketops_scheduled_job_runs`/`statuses` evidence and cleanup proof.
- [K8S-3 dedicated staging database gate — 2026-09-12](k8s3_dedicated_staging_database_gate_2026-09-12.md): dedicated non-production MarketOps primary/temporal DB services, OpenBao runtime routing, and scheduler-status parity proof without provider polling.
- [K8S-3 OpenBao CA trust gate — 2026-09-12](k8s3_openbao_ca_trust_gate_2026-09-12.md): SignalOps staging app/MarketOps injector annotations now use a verified CA bundle instead of TLS skip-verify.
- [K8S-3 CronJob unsuspend/resuspend smoke — 2026-09-12](k8s3_cronjob_unsuspend_resuspend_smoke_2026-09-12.md): one no-provider CronJob controller smoke with OpenBao HTTPS injection, immediate resuspend, DB scheduler-status parity, and cleanup proof.
- [K8S-3 provider-enabled CronJob smoke — 2026-09-12](k8s3_provider_cronjob_smoke_2026-09-12.md): one approved FMP annual provider call through a staged Kubernetes CronJob, no retries, DB evidence, immediate resuspend, and cleanup proof.
- [K8S-4 Signal-Connect shadow scaffold — 2026-09-13](k8s4_signal_connect_shadow_scaffold_2026-09-13.md): Signal-Connect persister/outbox K3s worker scaffold, private GHCR image publication and pull smoke, dormant replicas-zero apply, and remaining scale-to-one shadow gate.
- [K8S-4 Signal-Connect shadow smoke — 2026-09-13](k8s4_signal_connect_shadow_smoke_2026-09-13.md): staging Redpanda broker, OpenBao non-production runtime, sequential persister/outbox scale-to-one proof, and zero-replica restoration.
- [K8S-5 raw-worker scaffold — 2026-09-13](k8s5_raw_worker_scaffold_2026-09-13.md): Python normalized-event worker K3s scaffold, private GHCR image publication/pull smoke, dormant apply, and remaining one-message processing shadow gate.
- [K8S-2 OpenBao app staging role handoff — 2026-09-12](k8s2_openbao_app_staging_role_handoff_2026-09-12.md): safe OpenBao admin-token handoff script for placeholder staging app runtime path and cross-plane denial proof.
...
- [Mesh-3 authenticated Keycloak staging-route blocker — 2026-09-13](k8s_mesh3_keycloak_staging_route_blocker_2026-09-13.md): authenticated mesh parity is blocked by OIDC discovery/JWKS reachability returning WAF 503 before Keycloak login.
