...
- [Kubernetes/OpenBao staging cutover gate](k8s_openbao_staging_cutover_gate.md): controlled staging sequence, OpenBao HA evidence requirements, parity gates, and production cutover blockers.
