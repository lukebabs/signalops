...
1. Publish `ghcr.io/syncratic-inc/signalops-marketops-k8s-job-runner:staging` and verify private GHCR pull. Closed after GHCR package-write permission was corrected.
