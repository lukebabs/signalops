...
minimum_equity_symbols="${MARKETOPS_DAILY_MIN_EQUITY_SYMBOLS:-45}"
...
option_symbols="${MARKETOPS_DAILY_OPTION_SYMBOLS:-AAPL,GOOGL,MSFT,AMZN,TSM,SPCX,AVGO,TSLA,META,MU,BRK.B,LLY,JPM,AMD,WMT,ASML,V,JNJ,INTC,XOM,TCEHY,MA,AMAT,ABBV,CSCO,CAT,LRCX,BAC,COST,ORCL,GE,UNH,KO,MS,HD,PG,ARM,HSBC,CVX,NFLX,PLTR,MRK,GS,GEV,NVDA}"
