...
systemctl --user enable --now signalops-marketops-daily.timer signalops-marketops-intraday.timer signalops-marketops-fmp-continuation.timer signalops-storage-monitor.timer signalops-retention-governance.timer
