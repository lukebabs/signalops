...
export interface MarketOpsSignalAssuranceReadiness { tenant_id:string; readiness_state:string; readiness_reasons:string[]; active_contract_count:number; live_contract_count:number; research_contract_count:number; assertion_count:number; live_assertion_count:number; research_assertion_count:number; succeeded_materialization_count:number; directional_materialization_count:number; non_directional_materialization_count:number; contract_covered_materialization_count:number; contract_blocked_materialization_count:number; latest_materialization_at?:string; latest_assertion_at?:string; }
export interface MarketOpsSignalAssuranceReadinessResponse { readiness: MarketOpsSignalAssuranceReadiness; }
...
export interface MarketOpsSignalAssuranceDailyCohortValidation { session_date: string; cohort_size: number; signal_coverage: number; directional_signals: number; evaluated: number; directional_hits: number; directional_accuracy?: number; average_forward_return?: number; }
export interface MarketOpsSignalAssuranceDailyCohortValidationResponse { validation: MarketOpsSignalAssuranceDailyCohortValidation[]; data_scope: string; evidence_note: string; watchlist_context?: SubscriberWatchlistContext; }
