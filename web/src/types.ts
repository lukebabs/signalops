...
export interface SubscriberSubjectSubscriptionAdminRecord { tenant_id:string; subject:string; subscription_id:string; product_key:string; display_name:string; status:string; trial_ends_at?:string; current_period_ends_at?:string; grace_ends_at?:string; canceled_at?:string; stripe_customer_id?:string; stripe_subscription_id?:string; provisioned_by:string; correlation_id:string; created_at:string; updated_at:string; }
...
export interface SubscriberSubscriptionAdministrationResponse { tenant_id:string; products:SubscriberSubscriptionProduct[]; subject_subscriptions:SubscriberSubjectSubscriptionAdminRecord[]; tenant_subscriptions:SubscriberTenantSubscriptionAdminRecord[]; seats:SubscriberSubscriptionSeatAdminRecord[]; audit_events:SubscriberSubscriptionAuditAdminRecord[]; billing_webhook_events:SubscriberBillingWebhookAdminRecord[]; }
...
export interface SubscriberSubscriptionProductBillingRequest { stripe_product_id:string; stripe_monthly_price_id:string; stripe_annual_price_id:string; correlation_id?:string; }
