...
export interface SubscriberSubscriptionAdministrationResponse { tenant_id:string; products:SubscriberSubscriptionProduct[]; subject_subscriptions:SubscriberSubjectSubscriptionAdminRecord[]; tenant_subscriptions:SubscriberTenantSubscriptionAdminRecord[]; seats:SubscriberSubscriptionSeatAdminRecord[]; audit_events:SubscriberSubscriptionAuditAdminRecord[]; billing_webhook_events:SubscriberBillingWebhookAdminRecord[]; upgrade_interactions?:SubscriberUpgradeInteractionRecord[]; }
