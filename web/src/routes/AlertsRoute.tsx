  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-sm">
        <div><div className="text-xs text-gray-500">Type</div><div className="break-all text-xs font-mono">{alert.alert_type}</div></div>
        ...
        <div><div className="text-xs text-gray-500">Dataset</div><div className="break-all text-xs">{alert.dataset}</div></div>
        ...
        <div><div className="text-xs text-gray-500">Tenant</div><div className="break-all text-xs font-mono">{alert.tenant_id}</div></div>
