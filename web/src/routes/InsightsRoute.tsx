  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-sm">
        <div><div className="text-xs text-gray-500">Type</div><div className="break-all text-xs font-mono">{insight.insight_type}</div></div>
        <div><div className="text-xs text-gray-500">Confidence</div><div>{insight.confidence.toFixed(2)}</div></div>
        <div><div className="text-xs text-gray-500">Signal</div><div className="break-all text-xs"><Link to="/signals" className="font-mono text-brand-700 hover:underline">{insight.signal_id}</Link></div></div>
        <div><div className="text-xs text-gray-500">Detector</div><div className="break-all text-xs font-mono">{insight.detector_id}</div></div>
        <div><div className="text-xs text-gray-500">Source</div><div className="break-all text-xs font-mono">{insight.source_id}</div></div>
        <div><div className="text-xs text-gray-500">Dataset</div><div className="break-all text-xs">{insight.dataset}</div></div>
        <div><div className="text-xs text-gray-500">Source Domain</div><div className="break-all text-xs font-mono">{insight.source_domain}</div></div>
        <div><div className="text-xs text-gray-500">Source Adapter</div><div className="break-all text-xs font-mono">{insight.source_adapter}</div></div>
        ...
        <div><div className="text-xs text-gray-500">Tenant</div><div className="break-all text-xs font-mono">{insight.tenant_id}</div></div>
