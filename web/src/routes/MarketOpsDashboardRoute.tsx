            ...
            return (
              ...
              >
                ...
                <div className="mt-2 flex items-center justify-between gap-2 text-[11px] text-gray-500 dark:text-gray-400">
                  ...
                  <span className="font-medium text-brand-700 dark:text-brand-300">{expandedNarrativeId === summary.insightId ? "Hide" : ask.present ? "Read Ask" : "Read full"}</span>
                </div>
              </button>
            );
          })}
...
function DashboardSyncraticFullNarrative({
  ...
  const explanationLabel = ask.present ? "Ask Explanation" : "Deterministic Explanation";
  return (
    <div className="mt-3 rounded border border-brand-200 bg-brand-50/40 p-3 dark:border-brand-800 dark:bg-brand-950/20">
      ...
      <div className="mt-3">
        <div className="mb-1 flex flex-wrap items-center gap-2">
          ...
          {ask.present ? (
            <span className="text-[11px] text-gray-500 dark:text-gray-400">generated by Syncratic Ask over the bounded context window</span>
          ) : null}
        </div>
        ...
        {ask.present ? (
          <div className="mt-1 text-[11px] text-gray-500 dark:text-gray-400">
            SignalOps deterministic context and evidence references remain available in Syncratic Intelligence. This explanation is Syncratic Ask output, not deterministic synthesis.
          </div>
        ) : null}
      </div>
