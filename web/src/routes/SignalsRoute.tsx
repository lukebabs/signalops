  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-sm">
        <div><div className="text-xs text-gray-500">Type</div><div className="break-all text-xs">{signal.signal_type}</div></div>
        ...
        <div><div className="text-xs text-gray-500">Model</div><div className="break-all text-xs font-mono">{signal.model_version}</div></div>
        <div><div className="text-xs text-gray-500">Source</div><div className="break-all text-xs font-mono">{signal.source_id}</div></div>
        <div><div className="text-xs text-gray-500">Dataset</div><div className="break-all text-xs">{signal.dataset}</div></div>
        ...
        <div><div className="text-xs text-gray-500">Broker</div><div className="break-all text-xs font-mono">{signal.broker_partition}/{signal.broker_offset}</div></div>
      </div>
      <div>
