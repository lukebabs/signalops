...
import { useAdministrationNotifications, useAdministrationSMTPSettings, useMutateAdministrationSMTPSettings, useHealthz, useReadyz, useRuns, useReplayStatus, useScheduledJobs, useStorageOverview, useMutateAdministrationNotificationState } from '../api/queries';
