...
var g137FeatureSpecs = []featureSpec{
	...
	{Key: "surface_coverage_ratio", Domain: "volatility_surface", Title: "Required IV surface-cell coverage", Unit: "ratio", RequiredInputs: []string{"options.implied_volatility", "options.delta", "options.expiration_date"}, Calculation: map[string]any{"operator": "selected_cells_divided_by_required_cells", "required_cells": 5}},
